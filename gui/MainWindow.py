...
"//rgb(238, 238, 236)")
        ...
        self.tabWidget = QtWidgets.QTabWidget(self.tab_setup)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_11.setGeometry(QtCore.QRect(10, 10, 67, 17))
        self.label_11.setObjectName("label_11")
        self.label_12 = QtWidgets.QLabel(self.tab_7)
        self.label_12.setGeometry(QtCore.QRect(10, 50, 67, 17))
        self.label_12.setObjectName("label_12")
        self.lineEdit = QtWidgets.QLineEdit(self.tab_7)
        self.lineEdit.setGeometry(QtCore.QRect(70, 10, 251, 25))
        self.lineEdit.setObjectName("lineEdit")
        self.lineEdit_2 = QtWidgets.QLineEdit(self.tab_7)
        self.lineEdit_2.setGeometry(QtCore.QRect(70, 50, 251, 25))
        self.lineEdit_2.setObjectName("lineEdit_2")
        self.pushButton = QtWidgets.QPushButton(self.tab_7)
        self.pushButton.setGeometry(QtCore.QRect(50, 130, 89, 25))
        self.pushButton.setObjectName("pushButton")
        self.pushButton_2 = QtWidgets.QPushButton(self.tab_7)
        self.pushButton_2.setGeometry(QtCore.QRect(200, 130, 89, 25))
        self.pushButton_2.setObjectName("pushButton_2")
        self.tabWidget.addTab(self.tab_7, "")
        self.tab_8 = QtWidgets.QWidget()
        self.tab_8.setObjectName("tab_8")
        self.layoutWidget = QtWidgets.QWidget(self.tab_8)
        self.layoutWidget.setGeometry(QtCore.QRect(0, 0, 371, 164))
        ...
        self.setupBg_groupBox = QtWidgets.QGroupBox(self.layoutWidget)
        ...
        self.readerName_lineEdit = QtWidgets.QLineEdit(self.layoutWidget)
        ...
        self.qtdTotalTansitions_label = QtWidgets.QLabel(self.layoutWidget)
        ...
        self.nAntennas_spinBox = QtWidgets.QSpinBox(self.layoutWidget)
        ...
        self.addIP_pushButton = QtWidgets.QPushButton(self.layoutWidget)
        ...
        brush = QtGui.QBrush(QtGui.QColor(60, 167, 61, 128))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_7), _translate("MainWindow", "Init"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_8), _translate("MainWindow", "Config"))
        ...
        self.generateNewPNML_pushButton.setText(_translate("MainWindow", "GENERATE NEW PNML"))
